...
// due interi condivisi, 1 semaforo e un ciclo di attesa nel main
...
int main(int argc,char *argv[])
{
  ...
  int shm_size = 2*sizeof(int); // numero di byte necessari
  ...
  while(a[1]<n) // brutto ma funziona
    sleep(1);
