...
* ma non ci riesce ... comunque vada il programma non funzionerà sempre ...
*/
...
int main(int argc, char **argv)
{
    ...
    if(pid==0){
        ...
        //sleep per aggirare problema sincronia dello scheduler
        printf("[Figlio%d] vado a dormire per qualche secondo\n", numFiglio);
        sleep(5); // dormi per 2 secondi
        ...
        for(int i=0; i<n; i++){
            ...
            printf("[Padre] attesa del %d ^o processo\n", i+1);
            pause();
        }
